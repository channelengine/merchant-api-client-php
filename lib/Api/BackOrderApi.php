...
class BackOrderApi
{
     ...
     *
     * @param \Swagger\Client\Model\BackOrderViewModel $back_order  (required)
     * @return \Swagger\Client\Model\Object
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function backOrderCreate($back_order)
    {
        list($response, $statusCode, $httpHeader) = $this->backOrderCreateWithHttpInfo ($back_order);
        return $response; 
    }


    /**
     * backOrderCreateWithHttpInfo
     *
     * Mark (part of) an order as in backorder.
     *
     * @param \Swagger\Client\Model\BackOrderViewModel $back_order  (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->backOrderGetWithHttpInfo ($merchant_reference);
        return $response; 
    }


    /**
     * backOrderGetWithHttpInfo
     *
     * Retrieve a backorder by its reference. A back order references the order\r\n            which is temporarly out of stock.
     *
     * @param string $merchant_reference The unique backorder reference supplied by the merchant (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->backOrderIndexWithHttpInfo ($created_since);
        return $response; 
    }


    /**
     * backOrderIndexWithHttpInfo
     *
     * Gets all backorders created since the supplied date.
     *
     * @param \DateTime $created_since  (required)
