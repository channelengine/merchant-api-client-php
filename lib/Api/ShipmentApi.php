...
class ShipmentApi
{
     ...
     *
     * @param \Swagger\Client\Model\ShipmentViewModel $model  (required)
     * @return \Swagger\Client\Model\Object
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function shipmentCreate($model)
    {
        list($response, $statusCode, $httpHeader) = $this->shipmentCreateWithHttpInfo ($model);
        return $response; 
    }


    /**
     * shipmentCreateWithHttpInfo
     *
     * Mark (part of) an order as shipped.
     *
     * @param \Swagger\Client\Model\ShipmentViewModel $model  (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->shipmentIndexWithHttpInfo ($created_since);
        return $response; 
    }


    /**
     * shipmentIndexWithHttpInfo
     *
     * Gets all shipments created since the supplied date.
     *
     * @param \DateTime $created_since  (required)
