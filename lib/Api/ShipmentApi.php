...
class ShipmentApi
{
     ...
     * @param  \DateTime $fromDate Filter on the shipment date, starting from this date. This date is inclusive. (optional)
     * @param  \DateTime $toDate Filter on the shipment date, until this date. This date is exclusive. (optional)
     ...
     */
    public function shipmentIndex($merchantShipmentNos = null, $merchantOrderNos = null, $method = null, $shippedFromCountryCodes = null, $fromDate = null, $toDate = null, $page = null)
    {
        list($response) = $this->shipmentIndexWithHttpInfo($merchantShipmentNos, $merchantOrderNos, $method, $shippedFromCountryCodes, $fromDate, $toDate, $page);
        return $response;
    }
     ...
     */
    public function shipmentIndexWithHttpInfo($merchantShipmentNos = null, $merchantOrderNos = null, $method = null, $shippedFromCountryCodes = null, $fromDate = null, $toDate = null, $page = null)
    {
        $request = $this->shipmentIndexRequest($merchantShipmentNos, $merchantOrderNos, $method, $shippedFromCountryCodes, $fromDate, $toDate, $page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentIndexAsync($merchantShipmentNos = null, $merchantOrderNos = null, $method = null, $shippedFromCountryCodes = null, $fromDate = null, $toDate = null, $page = null)
    {
        return $this->shipmentIndexAsyncWithHttpInfo($merchantShipmentNos, $merchantOrderNos, $method, $shippedFromCountryCodes, $fromDate, $toDate, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentIndexAsyncWithHttpInfo($merchantShipmentNos = null, $merchantOrderNos = null, $method = null, $shippedFromCountryCodes = null, $fromDate = null, $toDate = null, $page = null)
    {
        $returnType = '\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantShipmentResponse';
        $request = $this->shipmentIndexRequest($merchantShipmentNos, $merchantOrderNos, $method, $shippedFromCountryCodes, $fromDate, $toDate, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentIndexRequest($merchantShipmentNos = null, $merchantOrderNos = null, $method = null, $shippedFromCountryCodes = null, $fromDate = null, $toDate = null, $page = null)
    {
