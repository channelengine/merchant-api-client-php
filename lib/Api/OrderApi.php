...
class OrderApi
{
     ...
     * 
     *
     * @param \Swagger\Client\Model\OrderViewModel $model  (required)
     * @return \Swagger\Client\Model\Object
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function orderCreate($model)
    {
        list($response, $statusCode, $httpHeader) = $this->orderCreateWithHttpInfo ($model);
        return $response; 
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function orderGet($merchant_reference)
    {
        list($response, $statusCode, $httpHeader) = $this->orderGetWithHttpInfo ($merchant_reference);
        return $response; 
    }


    /**
     * orderGetWithHttpInfo
     *
     * 
     *
     * @param string $merchant_reference  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function orderGetWithHttpInfo($merchant_reference)
    {
        
        // verify the required parameter 'merchant_reference' is set
        if ($merchant_reference === null) {
            throw new \InvalidArgumentException('Missing the required parameter $merchant_reference when calling orderGet');
        }
  
        // parse inputs
        $resourcePath = "/v2/orders/{merchantReference}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * 
     *
     * @return \Swagger\Client\Model\OrderViewModel[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function orderGetNew()
    {
        list($response, $statusCode, $httpHeader) = $this->orderGetNewWithHttpInfo ();
        return $response; 
    }


    /**
     * orderGetNewWithHttpInfo
     *
     * 
     *
     * @return Array of \Swagger\Client\Model\OrderViewModel[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function orderGetNewWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Swagger\Client\Model\OrderViewModel[]'
            );
            ...
            return array(\Swagger\Client\ObjectSerializer::deserialize($response, '\Swagger\Client\Model\OrderViewModel[]', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Swagger\Client\ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\OrderViewModel[]', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
