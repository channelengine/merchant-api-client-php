...
/**
     ...
     *
     * @param  string $merchantOrderNo The unique order reference as used by the merchant. (required)
     * @param  \SplFileObject $invoice invoice (required)
     ...
     * @return \ChannelEngine\Merchant\ApiClient\Model\ApiResponse|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse
     */
    public function orderUploadInvoice($merchantOrderNo, $invoice, string $contentType = self::contentTypes['orderUploadInvoice'][0])
    {
        list($response) = $this->orderUploadInvoiceWithHttpInfo($merchantOrderNo, $invoice, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $merchantOrderNo The unique order reference as used by the merchant. (required)
     * @param  \SplFileObject $invoice (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['orderUploadInvoice'] to see the possible values for this operation
     *
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChannelEngine\Merchant\ApiClient\Model\ApiResponse|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderUploadInvoiceWithHttpInfo($merchantOrderNo, $invoice, string $contentType = self::contentTypes['orderUploadInvoice'][0])
    {
        $request = $this->orderUploadInvoiceRequest($merchantOrderNo, $invoice, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderUploadInvoiceAsync($merchantOrderNo, $invoice, string $contentType = self::contentTypes['orderUploadInvoice'][0])
    {
        return $this->orderUploadInvoiceAsyncWithHttpInfo($merchantOrderNo, $invoice, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderUploadInvoiceAsyncWithHttpInfo($merchantOrderNo, $invoice, string $contentType = self::contentTypes['orderUploadInvoice'][0])
    {
        $returnType = '\ChannelEngine\Merchant\ApiClient\Model\ApiResponse';
        $request = $this->orderUploadInvoiceRequest($merchantOrderNo, $invoice, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderUploadInvoiceRequest($merchantOrderNo, $invoice, string $contentType = self::contentTypes['orderUploadInvoice'][0])
    {
