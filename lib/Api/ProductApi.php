...
class ProductApi
{
     ...
     * Bulk Patch Products
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\Operation[] $operation 1) PropertiesToUpdate: Fields to update&lt;br /&gt;2) MerchantProductRequestModels: Products to be updated (optional)
     *
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChannelEngine\Merchant\ApiClient\Model\SingleOfProductCreationResult
     */
    public function productBulkPatch($operation = null)
    {
        list($response) = $this->productBulkPatchWithHttpInfo($operation);
        return $response;
    }
     ...
     */
    public function productBulkPatchWithHttpInfo($operation = null)
    {
        $request = $this->productBulkPatchRequest($operation);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productBulkPatchAsync($operation = null)
    {
        return $this->productBulkPatchAsyncWithHttpInfo($operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productBulkPatchAsyncWithHttpInfo($operation = null)
    {
        $returnType = '\ChannelEngine\Merchant\ApiClient\Model\SingleOfProductCreationResult';
        $request = $this->productBulkPatchRequest($operation);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productBulkPatchRequest($operation = null)
    {
