...
/**
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfProductCreationResult' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfProductCreationResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest[] $merchantProductExtraDataRequest merchantProductExtraDataRequest (optional)
     ...
     * Add/Update/Delete product extra data items.
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest[] $merchantProductExtraDataRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productBulkPatchExtraDataItems'] to see the possible values for this operation
     *
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantProductResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantProductResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfMerchantProductResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfMerchantProductResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
