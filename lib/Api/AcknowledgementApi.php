...
/**
 * AcknowledgementApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class AcknowledgementApi
{
     ...
     *
     * @param \Swagger\Client\Model\AcknowledgementViewModel $model Relations between the id&#39;s returned by ChannelEngine and the references\r\n            which the merchant uses (required)
    ...
    public function acknowledgementAcknowledgeOrderWithHttpInfo($model)
    {
        ...
        // parse inputs
        $resourcePath = "/v2/acknowledgements";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
