            ...
            switch($statusCode) {
                case 200:
                    if ('\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantOfferGetStockResponse' === '\SplFileObject') {
                        ...
                        if ('\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantOfferGetStockResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfDictionaryOfStringAndListOfString' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfDictionaryOfStringAndListOfString' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
