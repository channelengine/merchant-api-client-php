...
/**
     ...
     */
    public function listedProductGetByFilter($channelId, $page = null, string $contentType = self::contentTypes['listedProductGetByFilter'][0])
    {
        list($response) = $this->listedProductGetByFilterWithHttpInfo($channelId, $page, $contentType);
        return $response;
    }
     ...
     */
    public function listedProductGetByFilterWithHttpInfo($channelId, $page = null, string $contentType = self::contentTypes['listedProductGetByFilter'][0])
    {
        $request = $this->listedProductGetByFilterRequest($channelId, $page, $contentType);
     ...
     */
    public function listedProductGetByFilterAsync($channelId, $page = null, string $contentType = self::contentTypes['listedProductGetByFilter'][0])
    {
        return $this->listedProductGetByFilterAsyncWithHttpInfo($channelId, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listedProductGetByFilterAsyncWithHttpInfo($channelId, $page = null, string $contentType = self::contentTypes['listedProductGetByFilter'][0])
    {
        $returnType = '\ChannelEngine\Merchant\ApiClient\Model\CollectionOfChannelListedProductResponse';
        $request = $this->listedProductGetByFilterRequest($channelId, $page, $contentType);
     ...
     */
    public function listedProductGetByFilterRequest($channelId, $page = null, string $contentType = self::contentTypes['listedProductGetByFilter'][0])
    {
