...
class ChannelListedProductResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['channelStatus'] = $data['channelStatus'] ?? null;
        $this->container['ean'] = $data['ean'] ?? null;
        $this->container['exportStatus'] = $data['exportStatus'] ?? null;
        $this->container['merchantProductNo'] = $data['merchantProductNo'] ?? null;
        $this->container['lastExportedPrice'] = $data['lastExportedPrice'] ?? null;
        $this->container['lastExportedStock'] = $data['lastExportedStock'] ?? null;
    }
