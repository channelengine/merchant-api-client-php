...
/**
 * MerchantStockUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  ChannelEngine\Merchant\ApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MerchantStockUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantStockUpdateRequest';
    ...
    public function setMerchantProductNo($merchantProductNo)
    {
        if ((mb_strlen($merchantProductNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling MerchantStockUpdateRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($merchantProductNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling MerchantStockUpdateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setStock($stock)
    {
        ...
        if (!is_null($stock) && ($stock < 0)) {
            throw new \InvalidArgumentException('invalid value for $stock when calling MerchantStockUpdateRequest., must be bigger than or equal to 0.');
        }
