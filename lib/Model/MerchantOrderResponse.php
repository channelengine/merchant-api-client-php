...
class MerchantOrderResponse implements ArrayAccess
{
    ...
    protected static $attributeMap = [
        ...
        'canShipPartialOrderLines' => 'CanShipPartialOrderLines',
        'lines' => 'Lines',
        'phone' => 'Phone',
        'email' => 'Email',
    ...
    protected static $setters = [
        ...
        'canShipPartialOrderLines' => 'setCanShipPartialOrderLines',
        'lines' => 'setLines',
        'phone' => 'setPhone',
        'email' => 'setEmail',
    ...
    protected static $getters = [
        ...
        'canShipPartialOrderLines' => 'getCanShipPartialOrderLines',
        'lines' => 'getLines',
        'phone' => 'getPhone',
        'email' => 'getEmail',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['canShipPartialOrderLines'] = isset($data['canShipPartialOrderLines']) ? $data['canShipPartialOrderLines'] : null;
    ...
    /**
     * Gets canShipPartialOrderLines
     * @return bool
     */
    public function getCanShipPartialOrderLines()
    {
        return $this->container['canShipPartialOrderLines'];
    }

    /**
     * Sets canShipPartialOrderLines
     * @param bool $canShipPartialOrderLines
     * @return $this
     */
    public function setCanShipPartialOrderLines($canShipPartialOrderLines)
    {
        $this->container['canShipPartialOrderLines'] = $canShipPartialOrderLines;
    ...
    public function setChannelCustomerReference($channelCustomerReference)
    {
        if (!is_null($channelCustomerReference) && (strlen($channelCustomerReference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $channelCustomerReference when calling MerchantOrderResponse., must be smaller than or equal to 50.');
        }
        if (!is_null($channelCustomerReference) && (strlen($channelCustomerReference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $channelCustomerReference when calling MerchantOrderResponse., must be bigger than or equal to 0.');
        }
