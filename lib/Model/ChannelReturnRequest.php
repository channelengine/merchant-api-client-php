...
class ChannelReturnRequest implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'lines' => '\Swagger\Client\Model\ChannelReturnLineRequest[]',
        'reason' => 'string',
    ...
    /**
     * Gets lines
     * @return \Swagger\Client\Model\ChannelReturnLineRequest[]
     */
    ...
    /**
     * Sets lines
     * @param \Swagger\Client\Model\ChannelReturnLineRequest[] $lines
     * @return $this
     */
    ...
    public function setCustomerComment($customer_comment)
    {
        if (strlen($customer_comment) > 4001) {
            throw new \InvalidArgumentException('invalid length for $customer_comment when calling ChannelReturnRequest., must be smaller than or equal to 4001.');
        }
        if (strlen($customer_comment) < 0) {
            throw new \InvalidArgumentException('invalid length for $customer_comment when calling ChannelReturnRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMerchantComment($merchant_comment)
    {
        if (strlen($merchant_comment) > 4001) {
            throw new \InvalidArgumentException('invalid length for $merchant_comment when calling ChannelReturnRequest., must be smaller than or equal to 4001.');
        }
        if (strlen($merchant_comment) < 0) {
            throw new \InvalidArgumentException('invalid length for $merchant_comment when calling ChannelReturnRequest., must be bigger than or equal to 0.');
        }
