...
class ChannelProductResponse implements ArrayAccess
{
    ...
    protected static $attributeMap = [
        'id' => 'Id',
        'parentChannelReference' => 'ParentChannelReference',
    ...
    protected static $setters = [
        'id' => 'setId',
        'parentChannelReference' => 'setParentChannelReference',
    ...
    protected static $getters = [
        'id' => 'getId',
        'parentChannelReference' => 'getParentChannelReference',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['parentChannelReference'] = isset($data['parentChannelReference']) ? $data['parentChannelReference'] : null;
    ...
    /**
     * Gets parentChannelReference
     * @return string
     */
    public function getParentChannelReference()
    {
        return $this->container['parentChannelReference'];
    }

    /**
     * Sets parentChannelReference
     * @param string $parentChannelReference
     * @return $this
     */
    public function setParentChannelReference($parentChannelReference)
    {
        $this->container['parentChannelReference'] = $parentChannelReference;
