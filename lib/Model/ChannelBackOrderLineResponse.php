...
/**
 * ChannelBackOrderLineResponse Class Doc Comment
 *
 * @category    Class
 * @package     ChannelEngine\ApiClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ChannelBackOrderLineResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChannelBackOrderLineResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expectedDate'] === null) {
            $invalid_properties[] = "'expectedDate' can't be null";
        }
