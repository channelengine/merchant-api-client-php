...
class MerchantProductResponse implements ArrayAccess
{
    ...
    /**
     * Sets mapped_fields
     * @param map[string,string] $mapped_fields A channel can require certain fields to be available. The channel  can provide ChannelEngine with this fields after which the merchants  will be able to fill in this field using custom conditions in ChannelEngine.    There are five different
     * @return $this
     */
