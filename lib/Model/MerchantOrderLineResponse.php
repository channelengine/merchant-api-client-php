...
class MerchantOrderLineResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param double $originalUnitPriceInclVat The value of a single unit of the ordered product including VAT  (in the currency in which the order was paid for).
     *
     * @return $this
     */
     ...
     *
     * @param double $originalUnitVat The total amount of VAT charged over the value of a single unit of the ordered product  (in the currency in which the order was paid for).
     *
     * @return $this
     */
     ...
     *
     * @param double $originalLineTotalInclVat The total value of the order line (quantity * unit price) including VAT  (in the currency in which the order was paid for).
     *
     * @return $this
     */
     ...
     *
     * @param double $originalLineVat The total amount of VAT charged over the total value of the order line (quantity * unit price)  (in the currency in which the order was paid for).
     *
     * @return $this
     */
